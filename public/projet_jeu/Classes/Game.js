class Game {
    constructor() {
        ...
        this.isMovementDuringTurn = false
        this.isMergeDuringTurn = false
    }
    ...
    */
    ...
    movePawn(pawn, newPosition) {
        ...
        this.isMovementDuringTurn = true
    }
    ...
    isAddPawnPossible() {
        return this.isMergeDuringTurn == true || this.isMovementDuringTurn == true
    }
